...
class ModelPredictor:
    ...
    def load_models(self):
        try:
            if os.path.exists(settings.SPAM_MODEL_PATH):
                ...
                logger.warning(f"⚠ Spam model not found at {settings.SPAM_MODEL_PATH}")
            ...
            if os.path.exists(settings.FAKE_NEWS_MODEL_PATH):
                ...
                logger.warning(f"⚠ Fake news model not found at {settings.FAKE_NEWS_MODEL_PATH}")
    ...
    def predict_spam(self, text: str) -> Dict[str, Any]:
        ...
        probabilities = self.spam_model.predict_proba(vectorized)[0]
    ...
    def predict_fake_news(self, text: str) -> Dict[str, Any]:
        ...
        probabilities = self.fake_news_model.predict_proba(vectorized)[0]
